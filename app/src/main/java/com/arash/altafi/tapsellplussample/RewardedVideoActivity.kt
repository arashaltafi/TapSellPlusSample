...
import com.arash.altafi.tapsellplussample.databinding.ActivityRewardedVideoBinding
...
class RewardedVideoActivity : AppCompatActivity() {
    ...
    private fun requestAd() {
        binding.apply {
            TapsellPlus.requestRewardedVideoAd(this@RewardedVideoActivity, BuildConfig.TAPSELL_REWARDED_VIDEO,
    ...
    private fun showAd() {
        binding.apply {
            TapsellPlus.showRewardedVideoAd(this@RewardedVideoActivity, responseId,
